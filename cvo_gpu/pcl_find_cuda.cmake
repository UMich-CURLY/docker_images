...
message("${CMAKE_VERSION}, cmake version")
if(CMAKE_VERSION VERSION_GREATER_EQUAL 3.10) #3.11)
...
if(CUDA_FOUND)
  ...
  if (TRUE) #CMAKE_CUDA_COMPILER_ID STREQUAL "NVIDIA")
    if(${CUDA_VERSION_STRING} VERSION_GREATER_EQUAL "11.1")
      ...
      message("CMAKE_CUDA_COMPILER is ${CMAKE_CUDA_COMPILER}, EXIT_CODE is ${EXIT_CODE}, OUTPUT_VAL is ${OUTPUT_VAL}")
